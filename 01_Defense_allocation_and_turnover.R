...
turnover_spread <- (quantile(c(0:15), quants)/100)   # based on values from Falk et al 2018
...
png(filename = "/projectnb/dietzelab/malmborg/Ch3_PestDefense/allocation_turnover_parameter_surface.png",
    width = 13, height = 9,
    units = "in", res = 600)
# make heatmap:
